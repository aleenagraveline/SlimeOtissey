...
public class Crystal5Script extends Script{
            ...
            addConditionalScriptActionGroup(new ConditionalScriptActionGroup() {{
                addScriptAction(new ScriptAction() {
                    ...
                    public ScriptState execute() {
                        ...
                        Point location = map.getMapTile(12, 18).getLocation();

                        MapTile mapTile = new MapTileBuilder(blueShardsFrame)
                            .withTileType(TileType.NOT_PASSABLE)
                            .build(location.x, location.y);

                        map.setMapTile(12, 18, mapTile);
                        CaveThreeScreen.changeCounter += 1;
                        //scriptActions.add(new ChangeFlagScriptAction("crystal5Flag", true));
